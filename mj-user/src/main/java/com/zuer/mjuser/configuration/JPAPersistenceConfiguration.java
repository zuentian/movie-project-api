package com.zuer.mjuser.configuration;
...
@EnableJpaRepositories(basePackages = "com.zuer.mjuser.repository" )//启用JPA资源库并指定资源库接口位置
@EntityScan(basePackages = "com.zuer.mjuser.entity")//指定实体的位置
...
public class JPAPersistenceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource druidDataSource){
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.zuer.mjuser.entity");
